...
class Instive_Unyson_Google_Fonts {
...
add_action('init', 'instive_google_fonts_loads');
function instive_google_fonts_loads(){
	$load_google_fonts = instive_option('load_google_fonts');
	if($load_google_fonts =='yes'){
		add_action( 'wp_enqueue_scripts', array( 'Instive_Unyson_Google_Fonts', 'output_url' ), 9999 );
	}
}